...
def add_images(image_path, image_path2):
    ...
    img_resultante = cv2.add(image_cv, image_cv2)
    cv2.imshow('Imagem Resultante', img_resultante)
    cv2.waitKey(0)
    cv2.destroyAllWindows()

    cv2.imwrite('PBM/output/addingDistinctImages.jpg', img_resultante)
...
if __name__ == "__main__":
    ...
    add_images("PBM/assets/run-frame1.png", "PBM/assets/brain_app.jpg")
